...
bool LoadMedia()
{
	...
	else
	{
		...
		else
		{
			...
			if (!gMenuTexture.LoadFromFile("images/background/menu.png", gRenderer))
			{
				std::cout << "Failed to load menu image" << std::endl;
				success = false;
			}

			if (!gInstructionTexture.LoadFromFile("images/background/instruction.png", gRenderer))
			{
				std::cout << "Failed to load instruction image" << std::endl;
				success = false;
			}

			if (!gPlayButtonTexture.LoadFromFile("images/button/big_button/play_button.png", gRenderer))
			{
			...
			if (!gHelpButtonTexture.LoadFromFile("images/button/big_button/character_button.png", gRenderer))
			{
			...
			if (!gBackButtonTexture.LoadFromFile("images/button/big_button/back_button.png", gRenderer))
			{
			...
			if (!gExitButtonTexture.LoadFromFile("images/button/big_button/exit_button.png", gRenderer))
			{
			...
			if (!gPauseButtonTexture.LoadFromFile("images/button/big_button/pause_button.png", gRenderer))
			{
			...
			if (!gContinueButtonTexture.LoadFromFile("images/button/big_button/continue_button.png", gRenderer))
			{
			...
			if (!gGroundTexture.LoadFromFile("images/background/ground.png", gRenderer))
			{
				std::cout << "Failed to load ground image" << std::endl;
				success = false;
			}

			if (!gCharacterTexture.LoadFromFile("images/character/ronaldo.png", gRenderer))
			{
