...
void GenerateEnemy(Enemy& enemy1,
	...
	SDL_Renderer * gRenderer)
{
	enemy1.LoadFromFile("images/enemy/goal.png", gRenderer);
	enemy2.LoadFromFile("images/enemy/goal.png", gRenderer);
	enemy3.LoadFromFile("images/enemy/bottle.png", gRenderer);
	{
		gEnemyClips[0].x = 43 * 0;
		gEnemyClips[0].y = 0;
		gEnemyClips[0].w = 43;
		gEnemyClips[0].h = 43;

		gEnemyClips[1].x = 43 * 1;
		gEnemyClips[1].y = 0;
		gEnemyClips[1].w = 43;
		gEnemyClips[1].h = 43;
		...
		gEnemyClips[3].x = 43 * 3;
		gEnemyClips[3].y = 0;
		gEnemyClips[3].w = 43;
		gEnemyClips[3].h = 43;

		gEnemyClips[4].x = 43 * 4;
		gEnemyClips[4].y = 0;
		gEnemyClips[4].w = 43;
		gEnemyClips[4].h = 43;

		gEnemyClips[5].x = 43 * 5;
		gEnemyClips[5].y = 0;
		gEnemyClips[5].w = 43;
		gEnemyClips[5].h = 43;

		gEnemyClips[6].x = 43 * 6;
		gEnemyClips[6].y = 0;
		gEnemyClips[6].w = 43;
		gEnemyClips[6].h = 43;

		gEnemyClips[7].x = 43 * 7;
		gEnemyClips[7].y = 0;
		gEnemyClips[7].w = 43;
		gEnemyClips[7].h = 43;
	}
